        ...
        try:
            ...
            for status in statusEvents:
                ...
                if(count==0):
                    ...
                    insert_query = f"INSERT INTO [dbo].[SadleirsEvents] ([ConnoteNumber], [EventType], [EventDate], [EventTime], [Location], [ExtraInfo]) VALUES ('{status['connote']}', '{status['eventtype']}' , '{status['date']}' ,'10:00 AM', '{status['location']}','{status['extrainfo']}');"
